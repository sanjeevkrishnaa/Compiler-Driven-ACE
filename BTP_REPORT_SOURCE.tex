...
\section{Completed ACE static fixed-lead sensitivity}
...
\section{Historical shared-pool compiler comparison}
...
requests. The fixed row below is retained to document the historical complete
policy matrix; the audited six-lead table above is the current fixed-policy
...
\section{Historical native shared-pool compiler comparison}
...
\section{ACE adaptive-generation baseline}
