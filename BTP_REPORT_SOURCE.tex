...
\item Study \emph{online route adaptation}. At runtime, route choice may use
only information available then: free memories, pending demand, active
generation attempts, recent failures, queue length, and link availability. It
must not use future trace information beyond the explicit compiler policy under
test. The runtime experiment should compare deterministic XY, offline selected
paths, and online selected paths under identical seeds, capacity, demand
admission, and latency scope.
