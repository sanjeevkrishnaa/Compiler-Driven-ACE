...
\section{Research Narrative and Contributions}
...
\subsection{Progression of the work}
...
\subsection{Policies and memory model}
...
\subsection{Definitions used throughout the report}
...
\section{Experimental Method and Reproducibility}

\subsection{Immutable experiment contract}
...
\subsection{Classical topology alignment}
...
\subsection{Compiler scheduling and native integration}
...
\subsection{Analytical policy framework}
...
\subsection{Native physical request lifecycle}
...
\subsection{ACE lifecycle repair}
...
\section{Audited Results and Interpretation}
...
\subsection{Historical native physical 3+1 study}
\begin{center}
\begin{tabular}{lrrrr}
\toprule
...
\subsection{Historical corrected ACE static matrix}
\begin{center}
\begin{tabular}{lrrr}
\toprule
...
\subsection{Completed ACE shared-pool fixed-lead sensitivity}
...
\subsection{Six-lead matrices in progress}
...
\subsection{Strict compiler-only coverage diagnostic}
...
\subsection{Historical shared-pool compiler comparison}
...
\subsection{Historical native shared-pool compiler comparison}
...
\subsection{ACE adaptive-generation baseline}
...
\subsection{Audit and provenance summary}
\begin{center}
\begin{tabular}{lrrl}
\toprule
...
\section{Validation and Current Work}
...
\section{Evidence Index and Reproduction Guide}\label{chap:evidence}

\subsection{Canonical repositories}
\begin{itemize}
...
\subsection{Local source-of-truth files}
...
\subsection{Reproducing an audited ACE fixed-lead cell}
\begin{verbatim}
