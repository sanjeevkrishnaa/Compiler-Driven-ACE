...
class AdaptiveContinuousProtocol(Protocol):
    ...
    def __init__(self, owner: "QuantumRouterAdaptive", name: str, adaptive_max_memory: int, resource_reservation: ResourceReservationProtocolAdaptive, period: int = SECOND):
        ...
        self.num_generated_entanglement_pairs = 0
        self.num_used_entanglement_pairs = 0
        self.num_unused_entanglement_pairs = 0
    ...
    def get_fidelity(self, entanglement_pair: tuple) -> float:
        ...
        Return:
            float: the fidelity of the entanglement pair, will update the fidelity
                   Returns -1 if the quantum state no longer exists (stale entanglement pair)
        '''
        ...
        # Check if quantum states still exist before decohering
        qm = self.owner.timeline.quantum_manager
        if local_memory.qstate_key not in qm.states or remote_memory.qstate_key not in qm.states:
            return -1  # Stale entanglement pair
    ...
    def remove_entanglement_pair(self, entanglement_pair: tuple):
        ...
        '''
        self.num_used_entanglement_pairs += 1
    ...
    def create_purification_protocol(self, entanglement_pair: tuple, entanglement_pair2: tuple, rule: "Rule") -> BBPSSW_bds:
        ...
        # Only set to occupied if not already occupied
        if this_info1.state != this_info1.OCCUPIED:
            this_info1.to_occupied()                         # set memory_info to occupied
        if this_info2.state != this_info2.OCCUPIED:
